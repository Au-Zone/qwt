...
class MmlDocument : public Mml
{
	...
	QString fontName(QtMmlDocument::MmlFont type) const;
	void setFontName(QtMmlDocument::MmlFont type, const QString &name);
...
QString MmlDocument::fontName(QtMmlDocument::MmlFont type) const
{
    switch (type) {
	case QtMmlDocument::NormalFont:
	    return m_normal_font_name;
	case QtMmlDocument::FrakturFont:
	    return m_fraktur_font_name;
	case QtMmlDocument::SansSerifFont:
	    return m_sans_serif_font_name;
	case QtMmlDocument::ScriptFont:
	    return m_script_font_name;
	case QtMmlDocument::MonospaceFont:
	    return m_monospace_font_name;
	case QtMmlDocument::DoublestruckFont:
...
void MmlDocument::setFontName(QtMmlDocument::MmlFont type, const QString &name)
{
    switch (type) {
	case QtMmlDocument::NormalFont:
...
{
    QFont fn(document()->fontName(QtMmlDocument::NormalFont),
	...
	if (ok) {
	    if (mv & ScriptMV)
		fn.setFamily(document()->fontName(QtMmlDocument::ScriptFont));

	    if (mv & FrakturMV)
		fn.setFamily(document()->fontName(QtMmlDocument::FrakturFont));

	    if (mv & SansSerifMV)
		fn.setFamily(document()->fontName(QtMmlDocument::SansSerifFont));

	    if (mv & MonospaceMV)
		fn.setFamily(document()->fontName(QtMmlDocument::MonospaceFont));

	    if (mv & DoubleStruckMV)
		fn.setFamily(document()->fontName(QtMmlDocument::DoublestruckFont));
...
/*!
    ...
    \sa setFontName()  setBaseFontPointSize() baseFontPointSize() QtMmlDocument::MmlFont
*/
QString QtMmlDocument::fontName(QtMmlDocument::MmlFont type) const
{
...
/*!
    ...
    \sa fontName() setBaseFontPointSize() baseFontPointSize() QtMmlDocument::MmlFont
*/
void QtMmlDocument::setFontName(QtMmlDocument::MmlFont type, const QString &name)
{
