 ...
 */
Qt::TimeSpec QwtDateTimeScaleDraw::timeSpec() const
{
 ...
 */
void QwtDateTimeScaleDraw::setDateFormat( 
 ...
 */
QString QwtDateTimeScaleDraw::dateFormatOfDate( const QDateTime &dateTime,
    QwtDate::IntervalType intervalType ) const
{
    Q_UNUSED( dateTime )
