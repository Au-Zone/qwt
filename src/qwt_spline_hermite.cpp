...
QwtSplineHermite::QwtSplineHermite()
{
}
...
QPainterPath QwtSplineHermite::path( const QPolygonF &points ) const
{
    QPainterPath path;
...
QPolygonF QwtSplineHermite::polygon( int numPoints, const QPolygonF &points ) const
{
    if ( points.size() <= 2 )
        return points;
...
QVector<QwtSplinePolynom> QwtSplineHermite::polynoms( const QPolygonF &points ) const
{
...
QPainterPath QwtSplineHermite::parametricPath( const QPolygonF &points ) const
{
    QPainterPath path;
